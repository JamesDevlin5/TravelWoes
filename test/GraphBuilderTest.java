...
class GraphBuilderTest {
    ...
    void parseInputTest1() {
        ...
        assertEquals(1, this.tester.edges[1].getVertex());
        assertEquals(1, this.tester.edges[1].getWeight());
        assertEquals(1, this.tester.source);
    ...
    void parseInputTest2() {
        ...
        assertEquals(1, this.tester.edges[2].getWeight());
        assertEquals(1, this.tester.source);
    ...
    void parseInputTest3() {
        ...
        assertEquals(2, this.tester.edges[1].getRest().getVertex());
        assertEquals(1, this.tester.edges[1].getRest().getWeight());
        assertEquals(1, this.tester.edges[4].getVertex());
        assertEquals(2, this.tester.edges[4].getWeight());
        assertEquals(3, this.tester.edges[2].getVertex());
        assertEquals(2, this.tester.edges[2].getWeight());
        assertEquals(3, this.tester.edges[1].getVertex());
        assertEquals(5, this.tester.edges[1].getWeight());
        assertEquals(1, this.tester.source);
    ...
    void parseInputTest4() {
        ...
        assertEquals(4, this.tester.numV);
        assertEquals(4, this.tester.numE);
        assertEquals(1, this.tester.edges[4].getRest().getVertex());
        assertEquals(1, this.tester.edges[4].getRest().getWeight());
        assertEquals(3, this.tester.edges[1].getVertex());
        ...
        assertEquals(4, this.tester.edges[2].getVertex());
        assertEquals(1, this.tester.edges[2].getWeight());
        assertEquals(4, this.tester.source);
        assertEquals(2, this.tester.target);
    }
    ...
    void parseInputTest5() {
        ...
        assertEquals(3, this.tester.edges[4].getVertex());
        assertEquals(3, this.tester.edges[4].getWeight());
        assertEquals(4, this.tester.edges[5].getVertex());
        assertEquals(4, this.tester.edges[5].getWeight());
        assertEquals(5, this.tester.edges[6].getVertex());
        assertEquals(5, this.tester.edges[6].getWeight());
        assertEquals(6, this.tester.edges[7].getVertex());
        assertEquals(6, this.tester.edges[7].getWeight());
        assertEquals(7, this.tester.edges[8].getVertex());
        assertEquals(7, this.tester.edges[8].getWeight());
        assertEquals(8, this.tester.edges[1].getVertex());
        assertEquals(8, this.tester.edges[1].getWeight());
        assertEquals(1, this.tester.source);
    ...
    void parseInputTest6() {
        ...
        assertEquals(2, this.tester.edges[1].getRest().getVertex());
        assertEquals(4, this.tester.edges[1].getRest().getWeight());
        assertEquals(3, this.tester.edges[1].getVertex());
        assertEquals(2, this.tester.edges[1].getWeight());
        assertEquals(3, this.tester.edges[2].getRest().getRest().getVertex());
        assertEquals(2, this.tester.edges[2].getRest().getRest().getWeight());
        assertEquals(2, this.tester.edges[3].getRest().getRest().getVertex());
        assertEquals(1, this.tester.edges[3].getRest().getRest().getWeight());
        assertEquals(4, this.tester.edges[2].getRest().getVertex());
        assertEquals(2, this.tester.edges[2].getRest().getWeight());
        assertEquals(5, this.tester.edges[3].getRest().getVertex());
        assertEquals(4, this.tester.edges[3].getRest().getWeight());
        assertEquals(4, this.tester.edges[5].getVertex());
        assertEquals(1, this.tester.edges[5].getWeight());
        assertEquals(5, this.tester.edges[2].getVertex());
        assertEquals(3, this.tester.edges[2].getWeight());
        assertEquals(4, this.tester.edges[3].getVertex());
        assertEquals(4, this.tester.edges[3].getWeight());
        assertEquals(1, this.tester.source);
        assertEquals(5, this.tester.target);
